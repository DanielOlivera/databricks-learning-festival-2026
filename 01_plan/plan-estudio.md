# Plan de estudio — Databricks Advanced Learning Festival 2026

> **Fuente oficial:** [Página del evento en Databricks Community](https://community.databricks.com/t5/learning-events/databricks-advanced-learning-festival-september-16-october-14/ev-p/166157)
> Enlaces y temarios revisados en la Customer Academy el 22-sep-2026.
> Ventana: **16-sep → 14-oct-2026** · Voucher (50% en certificación + 20% en Academy Labs) llega el **19-oct** al correo de la Customer Academy · Examen antes del **~15-ene-2027**.
...
| Ruta | Módulos (cursos) | Lecciones | Duración oficial | Costo |
|---|---|---|---|---|
| Associate Data Engineering | 4 | 61 | 8 h | Gratis |
| Generative AI Engineering | 4 | 43 | 8 h | Gratis |
| Professional Data Engineering | 4 | 73 | 8 h | Gratis |
| **Total** | **12** | **177** | **24 h** | **$0** |

Usa siempre los **enlaces de abajo**: llevan a la versión *E-learning gratuita*. Si buscas por nombre, primero aparece la versión *Instructor-led* ($750).
...
### Semana 1 — Associate Data Engineering (asegura el voucher)
| Día | Fecha | Tarea | h |
|---|---|---|---|
| Mar | 22-sep | Setup del workspace + **1.1 Lakeflow Connect**, lecciones 1-9 | 2.5 |
| Mié | 23-sep | **1.1**, lecciones 10-16 (incluye Quiz) | 2.5 |
...
| Día | Fecha | Tarea | h |
|---|---|---|---|
| Lun | 28-sep | **2.1 RAG Agents** (10 lecciones) | 3 |
| Mar | 29-sep | **2.2 Agentic Applications** (10 lecciones) | 3 |
...
| Día | Fecha | Tarea | h |
|---|---|---|---|
| Lun | 05-oct | **3.1 Advanced SDP** (15 lecciones) | 3 |
| Mar | 06-oct | **3.2 Data Privacy**, S1-S2 | 2.5 |
| Mié | 07-oct | **3.2**, S3-S4 + Quiz | 2.5 |
...
## Fase de exámenes (después del festival)

| Examen | Preguntas / tiempo | Fecha objetivo | Costo |
|---|---|---|---|
| Data Engineer Associate | 45 / 90 min | 1ª semana de noviembre | **$100 (voucher)** |
| Generative AI Engineer Associate | 45 / 90 min | fin de noviembre | $200 |
| Data Engineer Professional | 59 / 120 min | diciembre o enero | $200 |

Solo hay **un voucher por persona**. Úsalo en el primer examen, antes del 15-ene.

**Temario de cada examen (peso %)**
- **DE Associate:** Plataforma 6 · Ingesta y carga 21 · Transformación y modelado 22 · Lakeflow Jobs 16 · CI/CD 10 · Troubleshooting y optimización 10 · Gobierno y seguridad 15
- **GenAI Associate:** Diseño de apps 14 · Preparación de datos 14 · Desarrollo de apps 30 · Ensamble y deploy 22 · Gobierno 8 · Evaluación y monitoreo 12
...
- [ ] Webassessor con el mismo correo que la Customer Academy
- [ ] 19-oct: revisar el correo (y spam) para ver si llegó el voucher
